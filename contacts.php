...
<body class="fix-header card-no-border">
    ...
    <div id="main-wrapper">
      ...
      <div class="card ; card-bg-color;card-margin-padding" style="width: 100%; ">
        <img src="https://jujimufu.com/wp-content/uploads/acrobolix_product_frandenim_jeans_white.jpg" class="card-img-top" alt="...">
          <div class="card-body">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form>
                                                    YOUR RESPONSE HAVE BEEN RECORDED!!<br>
                                                    <br>
                        ...
                        <div class="card">
                            <div class="card-block">
                                <center class="m-t-30"> <img src="../assets/images/users/1.jpg" class="img-circle" width="150" />
                                    <h4 class="card-title m-t-10">shaswat shah</h4>
                                    <h6 class="card-subtitle">intern at nibodh</h6>
                            ...
                            <div class="card-block"> <small class="text-muted">Email address </small>
                                <a href="https://mail.google.com/mail/u/0/?tab=rm#inbox"><h6>shahshashwat3030@gmail.com</a></h6> <small class="text-muted p-t-30 db">Phone</small>
                                <h6>+91 9876543210</h6> <small class="text-muted p-t-30 db">Address</small>
                                <h6>borivali east mumbai-400066</h6>
                                <div class="map-box">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d30137.802902191514!2d72.84670504324029!3d19.22900763954472!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b0ce31d02bcb%3A0x4dcd57ec17d7d579!2sBorivali+East%2C+Mumbai%2C+Maharashtra!5e0!3m2!1sen!2sin!4v1559372008249!5m2!1sen!2sin" width="100%" height="150" frameborder="0" style="border:0" allowfullscreen></iframe> 
                                </div> <small class="text-muted p-t-30 db">Social Profile</small>
                                <br/>
                                <a href="https://www.facebook.com/">
                                <button class="btn btn-circle btn-secondary"><i class="fa fa-facebook"></i></a></button>
                                
                                <a href="https://github.com/"><button class="btn btn-circle btn-secondary"><i class="fa fa-github"></i></a></button>
                        
                                <a href="https://www.linkedin.com/feed/">
                                <button class="btn btn-circle btn-secondary"><i class="fa fa-linkedin"></i></a></button>
                            </div>
                        </div>
                    </div>
                    <Column >
